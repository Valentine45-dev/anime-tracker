...
-- Insert your first admin (replace with your actual user ID)
-- You'll need to get your user ID from the auth.users table first
-- INSERT INTO admins (user_id, email, role, permissions, created_by) VALUES 
-- ('your-user-id-here', 'your-email@example.com', 'super_admin', ARRAY['read', 'write', 'delete', 'admin'], 'your-user-id-here');
